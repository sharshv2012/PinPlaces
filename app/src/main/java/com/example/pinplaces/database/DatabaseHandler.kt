...
class DatabaseHandler(context : Context) : SQLiteOpenHelper(context , DATABASE_NAME , null , DATABASE_VERSION) {
    ...
    companion object{
        ...
        private const val DATABASE_NAME = "PinPlacesDatabase"
        private const val TABLE_PIN_PLACE = "PinPlaceTable"
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        val CREATE_HAPPY_PLACE_TABLE = ("CREATE TABLE " + TABLE_PIN_PLACE + " ("
    ...
    override fun onUpgrade(db: SQLiteDatabase? , oldVersion : Int , newVersion : Int){
        db!!.execSQL("DROP TABLE IF EXISTS $TABLE_PIN_PLACE")
        onCreate(db)
    }

    fun addPinPlace(pinPlace : PinPlaceModel): Long{
